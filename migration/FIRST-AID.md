...
These four answers changed the result materially, so they're recorded here rather
than left as assumptions:

- The count covers **all four boxes combined**, not one box.
- **"Washproof Plasters" means the blue visually-detectable ones only.** The box is
  nearly empty, so this line is treated as zero — not as the 222 beige adhesive
  bandages, which are a different item.
- Gloves were counted in **pairs** (6 pairs = 12 gloves).
- **Safety scissors do not satisfy Clothing Cutters**, **adhesive tape does not
  satisfy Waterproof Tape**, and **crepe cotton bandages do not count toward
  Conforming Bandages.** All three are treated as unmet.

The plaster answer is the consequential one. Read as beige adhesive bandages the
line was 62 *over*; read as blue detectable it is the largest gap in the kit.

## Shortfalls, in individual items

| item | need | have | order | note |
|---|---|---|---|---|
| **Washproof Plasters (blue detectable)** | 160 | 0 | **160** | box nearly empty — food-handling type, and there's a cafe on site |
| Sterile Wipes | 80 | 40 | **40** | |
| Finger Dressing | 8 | 1 | **7** | |
| Clothing Cutters | 4 | 0 | **4** | safety scissors don't count |
| Waterproof Tape | 4 | 0 | **4** | adhesive tape doesn't count |
| First Aid Dressing 12x12cm | 8 | 4 | **4** | |
| Safety Pins | 48 | 44 | **4** | |
| Burn Dressing 10x10cm | 4 | 2 | **2** | burn gel excluded |
| Conforming Bandages | 4 | 2 | **2** | crepe cotton excluded |
| First Aid Dressing 18x18cm | 4 | 3 | **1** | |
...
None of the 15 first-aid lines has a pack size or a price recorded, so the table
above is a shortfall in *items* and cannot yet become a costed order. Twelve
separate lines, each needing a pack size looked up, is a lot of admin for £4 of
safety pins.
...
Now that the required plaster line means blue detectable only, these are not that
item:

- 70× 7.2 × 1.9cm adhesive bandages
- 82× mixed size adhesive bandages (1 pack)
- 50× 7.2 × 2.5cm adhesive bandages
- 20× mixed size adhesive dressings (1 pack)

That is a large and genuinely useful stock of something the required list doesn't
track at all. Worth adding as its own line rather than leaving 222 items invisible
to the system — but that's a decision about the required list, not something to
infer from a count.

## Untracked extras (15 further lines)

Present in the kits, absent from the required list:

- 2× Elastic Bandage 7.5cm × 4.5m, 2× Elastic Bandage 10cm × 4m
- 4× Crepe Cotton Bandages
- 14× Absorbent Non-Woven Compress across five sizes (10×10, 7.5×7.5, 5×5,
  5.5×7.5, and a 10-ball pack)
- 1× Low Absorbent Dressing 10×10cm
- 1× Tourniquet
- 2× Sterile Eye Wash Pod
- 1× Emergency Burn Gel
- 2× Vinyl Gloves
- 2× Pack of Cotton Pads, 1× pack of Cotton Tips, 1× Bag of Cotton Wool Balls
- 1× First Aid Blanket
- 1× Plaster sheet
- 1× Tweezers

So the kits hold **35 distinct lines against a required list of 15**. The tourniquet
and eye wash pods in particular suggest someone added trauma items beyond the
original spec. Whether the required list should grow to cover these, or they stay
as untracked spares, is worth deciding once — otherwise every future count will
throw up the same 15 unexplained lines.
